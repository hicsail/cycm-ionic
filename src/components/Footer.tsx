...
const Footer = () => {
  ...
  const bgColor = route.pathname in bgColorMap ? bgColorMap[route.pathname as keyof typeof bgColorMap] : "#E55342";

  return (
    <div id="footer" className={`flex flex-col items-center bg-[${bgColor}]`}>
