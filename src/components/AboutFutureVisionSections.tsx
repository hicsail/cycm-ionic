      ...
      <div className="container sm:px-2 md:px-12 px-36 mx-auto flex flex-col gap-5 w-19/20 box-border md:flex-row">
        <IonCard className="flex-1 bg-white text-[#100f66]  rounded-lg shadow-md pb-5 pl-0 pr-10 mb-0 ml-0">
          <IonCardHeader className="text-left">
            <IonCardTitle className="text-[#100f66] font-bold text-4xl mb-4">COLLABORATIVE CREATION</IonCardTitle>
          </IonCardHeader>
        ...
        <IonCard className="flex-1 bg-white text-[#100f66] rounded-lg shadow-md pb-5 pl-0 pr-10 mb-0 ml-0">
          <IonCardHeader className="text-left">
            <IonCardTitle className="text-[#100f66] font-bold text-4xl mb-4">COMMUNITY ENGAGEMENT</IonCardTitle>
          </IonCardHeader>
          <IonCardContent className="text-left font-bold text-2xl mb-24">
