import { IonButton, IonCard, IonCardContent, IonCardHeader, IonCardSubtitle, IonCardTitle, IonChip, IonLabel } from '@ionic/react'
...
export default function IonicCard({ id, title, body, image, voiceId, isExpanded, setIsExpandedArray, index, manual_id, author, tag }: CardProps) {
