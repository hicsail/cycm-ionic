    ...
    <div className="flex flex-col md:flex-row justify-between max-w-7xl py-16 my-16 mx-auto">
      ...
      <div className="flex flex-col flex-1 justify-evenly max-w-[70%] md:max-w-[50%] space-y-4 p-4 mx-auto md:mx-0">
        ...
        <div className="w-full [font-family:'Montserrat',Helvetica] font-bold">
          ...
          <h1 className="text-6xl md:text-[72px] lg:text-[100px] leading-none">3.5 hrs</h1>
          <h4 className="text-2xl md:text-3xl lg:text-4xl leading-tight">
        ...
        <div className="w-full [font-family:'Montserrat',Helvetica] font-bold">
          ...
          <h1 className="text-6xl md:text-[72px] lg:text-[100px] leading-none">95%</h1>
          <h4 className="text-2xl md:text-3xl lg:text-2xl leading-tight">
