      ...
      <div className="relative max-w-[70%] md:max-w-[50%] mx-auto md:mx-0">
        ...
        <div className="absolute w-full top-[20%] px-10 md:px-16">
          <div className="[font-family:'Montserrat',Helvetica] font-bold text-white">
            <h1 className="text-7xl md:text-[120px] lg:text-[180px] leading-none">
              18
            </h1>
            <h1 className="text-5xl md:text-[72px] lg:text-[100px] leading-none">
              BILLION
            </h1>
      ...
      <div className="flex flex-col flex-1 justify-evenly max-w-[70%] md:max-w-[50%] space-y-4 p-4 mx-auto md:mx-0">
        ...
        <div className="w-full [font-family:'Montserrat',Helvetica] font-bold">
          <img
            src="/clock.svg"
            alt="Graphic 1"
            className="md:w-1/2 h-auto mb-4"
          />
          <h1 className="text-6xl md:text-[72px] lg:text-[100px] leading-none text-white">
            3.5 hrs
          </h1>
        ...
        <div className="w-full [font-family:'Montserrat',Helvetica] font-bold">
          <img
            src="/battery.svg"
            alt="Graphic 2"
            className="md:w-3/4 h-auto mb-4"
          />
          <h1 className="text-6xl md:text-[72px] lg:text-[100px] leading-none text-white">
            95%
          </h1>
