...
import { IonButton, IonCard, IonCardContent, IonCardHeader, IonCardTitle, IonChip, IonContent, IonIcon, IonItemDivider, IonLabel, IonSearchbar, IonText } from "@ionic/react";
...
const Discover: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const filteredArticles = articles.filter((article: any) => article.attributes.title.toLowerCase().includes(searchText.toLowerCase()));
      ...
      <div className="">
        <div>
          ...
          <div className="md:ml-24 my-4">
            <div style={{
              ...
              <IonCard
                ...
                <div className="flex justify-center">
                  <IonCardHeader>
                    <IonCardTitle className="text-2xl font-bold font-sans mb-2 md:mb-1 md:text-4xl">Explore what we have</IonCardTitle>
                  </IonCardHeader>
                </div>
                <IonCardContent>
              ...
              <div className="h-6" />
              <IonSearchbar onInput={(event:any)=>{
                console.log(event.target.value);
                setSearchText(event.target.value);
              }} mode="ios" animated={true} placeholder="Search for what you are looking for..." color={'warning'} style={{
                borderRadius: 40,
                maxWidth: 600,
                margin: 'auto'
              }}></IonSearchbar>
            ...
            <div className="mt-12">
            <div className="my-12 flex" style={{
              margin: 'auto',
              maxWidth: 1000
            }}>
              <label htmlFor="countries" className="block text-sm font-medium text-yellow-200 mx-2">
